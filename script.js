...
const testimonials = [
    ...
    },
    {
        ...
        date: "2024",
        text: "הגעתי לשיחת ייעוץ בחוסר ודאות גדולה, לא ידעתי אם טיפול זה בשבילי. רחל הקשיבה, שאלה את השאלות הנכונות, והסבירה איך הגישה של Li-CBT עובדת. יצאתי עם תחושה ברורה שמצאתי את המקום הנכון."
    }
];
